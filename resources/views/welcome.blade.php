...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @else
        <title>Job Listing  {{app('currentTenant')->name}}</title>
        @endif
        <!-- Style CSS -->
        <style>
    ...
    <body class="antialiased">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <!-- Login & Register Jetstream -->
                    ...
                    @endif
                @else
                    <h1>This is the Domain</h1>
                    <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                        <div>
                            <div class="p-6">
                                <div class="flex items-center">
                                    <div class="ml-4 text-lg leading-7 font-semibold">
                                        <h3 class="text-gray-900 dark:text-white">Multi-Tenant Job Listing App</h3>
                                    </div>
                                </div>
                                <div class="ml-12">
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify;">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Rationis enim perfectio est virtus; Tria genera bonorum; Sed haec in pueris; Quippe: habes enim a rhetoribus; 
